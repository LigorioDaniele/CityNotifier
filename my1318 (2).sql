...
--
-- Host: localhost
-- Generato il: Feb 12, 2014 alle 11:34
...
CREATE TABLE IF NOT EXISTS `Evento` (
  ...
  `Vote_Open` text COLLATE utf8_unicode_ci,
  `Vote_Closed` text COLLATE utf8_unicode_ci,
  `Vote_Archived` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
...
(1, 'FabioVitali', 'fv', 0, 1.01, 0, 2000, 44.4958, 11.3447, 'local', 'all', 'all', 1300000000, 1500000000, 'all'),
